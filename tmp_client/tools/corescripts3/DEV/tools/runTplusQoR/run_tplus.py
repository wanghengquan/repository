...
class RunThunderPlus(object):
    ...
    def get_options(self):
        ...
        parser.add_argument("--radiant", choices=list(radiant_dict.keys()), help="specify radiant build name")
    ...
    def write_lines(self):
        ...
        for k, v in list(syn_dict.items()):
            ...
            for design in os.listdir(_path):
                ...
                if os.path.isfile(abs_design):
                    continue
                print(r"{}\{} --design={} {} {} {}".format(self.common_string1, k, design, v,
                                                                        self.pb_or_sweep, self.common_string2), file=lines_ob)
        lines_ob.close()
