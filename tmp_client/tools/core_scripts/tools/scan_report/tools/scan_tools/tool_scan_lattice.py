...
class ScanLatticeTwr:
    def __init__(self, pap,all_clk=False):
        ...
        self.title = [r"Seed/Target","PAP", "PAPFactor", "targetFmax", "fmax", "clkName", "logic",
    ...
    def _get_lrl(self, clk_name):
        ...
        while True:
            ...
            if m_lrl:
                ...
                ori_dict = dict(zip(lrl_title, lrl_data))
...
class ScanLatticeTime(ScanBasic):
    ...
    def scan_mrp(self,mrp_file):
        ...
        _loads = [self.clk_loads[key] for key in self.clk_loads.keys()]
        try:
