...
class UploadSuites(object):
    ...
    def get_raw_cases(self):
        ...
        for foo in os.listdir(self.target_path):
            ...
            for raw_case in t:
                simple_case = dict()
                for k, v in list(raw_case.items()):
                    if not v:
                        continue
                    if k == "Order":
                        continue
    ...
    def write_section_cases(self):
        ...
        case_lines = list()
        for section_name, cases in list(self.final_section_cases.items()):
    ...
    def get_final_cases(self):
        ...
        for case in self.raw_cases:
            ...
            if not self.macro_dict:
                ...
                continue
            never_matched = 1
            for k, v in list(self.macro_dict.items()):
                # matched?
                matched_list = list()
                try:
                    for foo in v:
                    ...
                    if not original_settings:
                        ...
                        if foo[1] == self.cmd_key:
                            if _original_dict.get("override", "") == "local":
                                ...
                                for kk, vv in list(_macro_dict.items()):
    ...
    def update_this_section(self, section_name, section_id, cases_data):
        ...
        for k, v in list(cases_in_testrail_dict.items()):
