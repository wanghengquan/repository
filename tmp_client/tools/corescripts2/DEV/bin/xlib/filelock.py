...
"""
Extracted from 'pip download filelock'
...
def safe_run_function(func, args=None, kw=None, func_lock_file=None, timeout=600):
    ...
    file_locker = FileLock(func_lock_file, timeout)
    with file_locker:
        return func(*args, **kw)
