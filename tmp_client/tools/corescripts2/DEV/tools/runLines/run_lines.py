...
class RunLines(object):
    ...
    def get_options(self):
        ...
        parser.add_argument("-p", "--process", type=int, choices=range(2, 10), help="specify process number")
            ...
            for item in original_lines:
                if item in new_lines:
                    with open(done_file, "a") as ob:
                        print >> ob, self.done_template.format(self.machine, time.ctime(), item)
                    return item
