...
-- Module  Version: 3.1
--C:\ispTOOLS7_0\ispfpga\bin\nt\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch mg5a00 -type sdpram -rdata_width 11 -data_width 11 -num_rows 16 -outData UNREGISTERED -e 
...
architecture Structure of ddram_16x11_xp2 is
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of ddram_16x11_xp2 is
    for Structure
        for all:ROM16X1 use entity xp2.ROM16X1(V); end for;
        for all:DPR16X4A use entity xp2.DPR16X4A(V); end for;
