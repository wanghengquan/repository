...
-- Module  Version: 5.4
--C:\ispTOOLS8_1\ispfpga\bin\nt\scuba.exe -w -n scfifo_xo2 -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 16 -width 8 -rwidth 8 -no_enable -pe 2 -pf 14 -e 
...
architecture Structure of scfifo_xo2 is
...
begin
    ...
    scfifo_xo2_0_0: FIFO8KB
        generic map (FULLPOINTER1=> "0b00000011110000", FULLPOINTER=> "0b00000100000000", 
        AFPOINTER1=> "0b00000011010000", AFPOINTER=> "0b00000011100000", 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of scfifo_xo2 is
    for Structure
