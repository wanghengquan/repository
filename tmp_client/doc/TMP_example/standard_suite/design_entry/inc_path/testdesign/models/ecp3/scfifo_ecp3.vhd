...
-- Module  Version: 4.2
--C:\ispTOOLS7_1\ispfpga\bin\nt\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 16 -width 8 -depth 16 -no_enable -pe 2 -pf 14 -e 

-- Mon Jan 14 14:10:51 2008
...
architecture Structure of scfifo_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "scfifo_ecp3.lpc";
...
begin
    ...
    pdp_ram_0_0_0: DP16KC
        ...
        WRITEMODE_B=> "NORMAL", WRITEMODE_A=> "NORMAL", GSR=> "ENABLED", 
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            ADB13=>scuba_vlo, CEB=>rden_i, CLKB=>Clock, OCEB=>rden_i, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of scfifo_ecp3 is
    for Structure
