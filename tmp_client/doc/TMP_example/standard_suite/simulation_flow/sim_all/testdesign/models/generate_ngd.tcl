...
set Para(ModuleName) "module_top"
set Para(Module) "RAM_Based_Shift_Register"
set Para(libname) lifdb1
set Para(arch_name) sn5w00
set Para(PartType) "LIFDB1-5000E"

set Para(tech_syn) lifdb1
set Para(tech_cae) lifdb1
