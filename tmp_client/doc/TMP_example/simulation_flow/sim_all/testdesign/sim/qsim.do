...
#20140210 jason
#usage: 
#dev_lib example: D:\diamond_lib\msim_lib\ovi_lifmd
...
vlog	-sv ./RUT_lib/memory/ram_shift_register_module.v
vlog	-sv ./sim_tb.v
##<tb_end>
...
##<sim_start>
vsim -novopt -lib work sim_top  -L ovi_lifmd
if {$gui_cmd == "cmd"} {
    run 1us
    quit
} else {
