/* Verilog netlist generated by SCUBA Diamond Version 3.3.0.94 */
/* Module Version: 5.6 */
/* C:\lscc\diamond\3.3\ispfpga\bin\nt\scuba.exe -w -n equation_check -lang verilog -synth synplify -arch xo3c00a -type pll -fin 20 -fclkop 100 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Mon Aug 18 17:10:12 2014 */


`timescale 1 ns / 1 ps
module equation_check (CLKI, CLKOP)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute equation_check dont_touch true 
    input wire CLKI;
    output wire CLKOP;
