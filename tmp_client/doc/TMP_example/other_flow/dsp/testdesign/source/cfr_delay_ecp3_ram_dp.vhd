...
-- Module  Version: 6.1
--C:\ispTOOLS7_2\ispfpga\bin\nt\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type bram -wp 10 -rp 0011 -rdata_width 32 -data_width 32 -num_rows 256 -cascade -1 -e 

-- Wed Aug 19 23:58:19 2009
...
entity cfr_delay_ecp3_ram_dp is
    port (
...
end cfr_delay_ecp3_ram_dp;

architecture Structure of cfr_delay_ecp3_ram_dp is
    ...
    attribute MEM_LPC_FILE of cfr_delay_ecp3_ram_dp_0_0_0 : label is "cfr_delay_ecp3_ram_dp.lpc";
    attribute MEM_INIT_FILE of cfr_delay_ecp3_ram_dp_0_0_0 : label is "";
    attribute RESETMODE of cfr_delay_ecp3_ram_dp_0_0_0 : label is "SYNC";
...
begin
    ...
    cfr_delay_ecp3_ram_dp_0_0_0: PDPW16KC
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of cfr_delay_ecp3_ram_dp is
    for Structure
