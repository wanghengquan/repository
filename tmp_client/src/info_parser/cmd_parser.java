...
class cmd_parser {
	...
	private static Options get_options(){
		...
		options_obj.addOption(Option.builder("c")
				  .longOpt("cmd")
				  .desc("Client will run in Command modle")
				  .build()
				  );
		options_obj.addOption(Option.builder("g")
				  .longOpt("gui")
				  .desc("Client will run in GUI modle")
				  .build()
				  );		
		options_obj.addOption(Option.builder("l")
				  .longOpt("local")
				  .desc("Client will run in LOCAL modle")
				  .build()
				  );
		options_obj.addOption(Option.builder("r")
				  .longOpt("remote")
				  .desc("Client will run in REMOTE modle")
				  .build()
				  );		
		options_obj.addOption(Option.builder("f")
				  .longOpt("suite-file")
				  .hasArg()
				  .desc("Test suite file for Local run")
				  .build()
				  );
		options_obj.addOption(Option.builder("w")
				  .longOpt("work-path")
				  .hasArg()
				  .desc("Case run place, if not present will use current work path")
				  .build()
				  );
		options_obj.addOption(Option.builder("s")
				  .longOpt("save-path")
				  .hasArg()
				  .desc("Storage place for completed case, if not present will use current work_path")
				  .build()
				  );		
		options_obj.addOption(Option.builder("d")
				  .longOpt("debug")
				  .desc("Client will run in debug modle")
				  .build()
				  );		
		options_obj.addOption(Option.builder("h")
				  .longOpt("help")
				  .desc("Client will run in help modle")
				  .build()
				  );
		return options_obj;
	}
