...
public class public_data {
	...
	public final static String BASE_CURRENTVERSION = "2.10.66"; //main.xx.build. xx:odd for stable, even for develop
	public final static int BASE_CURRENTVERSION_INT = 21066; // version for code use
	public final static String BASE_BUILDDATE = "2020/03/13";
