...
public class public_data {
	...
	public final static String BASE_CURRENTVERSION = "2.08.41"; //main.xx.build. xx:odd for stable, even for develop
	public final static int BASE_CURRENTVERSION_INT = 20841; // version for code use
