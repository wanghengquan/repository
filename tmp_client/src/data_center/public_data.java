...
public class public_data {
	...
	// ========================
	// base
	public final static String BASE_CURRENTVERSION = "2.06.07"; //2.06.07 External.Internal.DEV
	public final static int BASE_CURRENTVERSION_INT = 20607; // version for code use
	public final static String BASE_BUILDDATE = "2017/08/10";
