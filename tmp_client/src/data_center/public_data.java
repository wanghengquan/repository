...
public class public_data {
	...
	public final static String BASE_CURRENTVERSION = "2.12.85"; //main.xx.build. xx:odd for stable, even for develop
	public final static int BASE_CURRENTVERSION_INT = 21285; //version for code use
	public final static String BASE_BUILDDATE = "2021/12/01";
	...
	public final static int PERF_SQUISH_MAXIMUM_CPU = 45;
	public final static int PERF_SQUISH_MAXIMUM_MEM = 55;
	...
	public static void main(String[] args) {
		...
		String expression = new String("a and b or c and d"); 
		System.out.println(expression);
		System.out.println(expression.split("\\s+"));
