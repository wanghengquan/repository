...
public class public_data {
	...
	// ========================
	// base
	public final static String BASE_CURRENTVERSION = "2.06.08"; //2.06.08 External.Internal.DEV
	public final static int BASE_CURRENTVERSION_INT = 20608; // version for code use
	public final static String BASE_BUILDDATE = "2017/08/11";
