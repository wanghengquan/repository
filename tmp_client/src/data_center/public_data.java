...
public class public_data {
	...
	public final static String BASE_CURRENTVERSION = "2.08.72"; //main.xx.build. xx:odd for stable, even for develop
	public final static int BASE_CURRENTVERSION_INT = 20872; // version for code use
	public final static String BASE_BUILDDATE = "2019/01/08";
    ...
    public final static int PERF_GUI_BASE_INTERVAL = 2;
